...
public class Particle extends Element {
    ...
    public Particle(int x, int y, Vector3f vel, ElementType elementType, Color color, boolean isIgnited) {
        super(x, y);
        ...
        Vector3f localVel = vel == null ? new Vector3f(0, -124, 0) : vel;
    ...
    public Particle(int x, int y, Vector3f vel, Element sourceElement) {
        super(x, y);
