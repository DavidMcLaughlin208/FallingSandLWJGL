...
public abstract class Element {
    ...
    public List<Vector2f> secondaryMatrixCoords = new ArrayList<>();
...
//    public abstract void draw(ShapeRenderer sr);
    ...
    protected abstract boolean actOnNeighboringElement(Element neighbor, int modifiedMatrixX, int modifiedMatrixY, CellularMatrix matrix, boolean isFinal, boolean isFirst, Vector3f lastValidLocation, int depth);
    ...
    public void moveToLastValid(CellularMatrix matrix, Vector3f moveToLocation) {
    ...
    public void moveToLastValidDieAndReplace(CellularMatrix matrix, Vector3f moveToLocation) {
        moveToLastValidDieAndReplace(matrix, moveToLocation, this.elementType);
    }

    public void moveToLastValidDieAndReplace(CellularMatrix matrix, Vector3f moveToLocation, ElementType elementType) {
    ...
    public void moveToLastValidAndSwap(CellularMatrix matrix, Element toSwap, int toSwapX, int toSwapY, Vector3f moveToLocation) {
    ...
    public void setOwningBodyCoords(Vector2f coords) {
        setOwningBodyCoords((int) coords.x, (int) coords.y);
    }

    public void setOwningBodyCoords(int x, int y) {
        this.owningBodyCoords = new Vector2f(x, y);
    }

    public void setCoordinatesByMatrix(Vector2f pos) {
    ...
    public void setSecondaryCoordinatesByMatrix(int providedX, int providedY) {
        this.secondaryMatrixCoords.add(new Vector2f(providedX, providedY));
    }
...
//            secondaryMatrixCoords.forEach(Vector2f -> matrix.setElementAtIndex((int) Vector2f.x, (int) Vector2f.y, ElementType.EMPTYCELL.createElementByMatrix(0, 0)));
//        }
    }
    ...
    public void dieAndReplaceWithParticle(CellularMatrix matrix, Vector3f velocity) {
    ...
    public boolean didNotMove(Vector3f formerLocation) {
